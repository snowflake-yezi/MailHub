...
assert.equal(i18n.t('pages:filterPolicy.seedCatalog.detectors.AD_PROMO_SUBJECT.name'), 'Promotional subject terms')
assert.match(i18n.t('pages:filterPolicy.seedCatalog.detectors.AD_TRANSACTIONAL_TEXT.description'), /negative weight/)
...
assert.equal(i18n.t('pages:filterPolicy.seedCatalog.detectors.AD_PROMO_SUBJECT.name'), '件名の販促語')
assert.match(i18n.t('pages:filterPolicy.seedCatalog.detectors.AD_TRANSACTIONAL_TEXT.description'), /負の重み/)
...
assert.equal(i18n.t('pages:filterPolicy.seedCatalog.detectors.AD_PROMO_SUBJECT.name'), '促销主题词')
assert.match(i18n.t('pages:filterPolicy.seedCatalog.detectors.AD_TRANSACTIONAL_TEXT.description'), /负权重/)
